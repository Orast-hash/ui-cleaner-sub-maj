...
$form.Size = New-Object System.Drawing.Size(520, 695)
...
$btnNavig.Text = "Réparer les navigateurs"
$btnNavig.Location = New-Object System.Drawing.Point(20, 597)
$btnNavig.Size = New-Object System.Drawing.Size(470, 34)
...
$btnNavig.Add_Click({
    ...
    $rep = [System.Windows.Forms.MessageBox]::Show($apercu,
        "Réparer les navigateurs - $NomEntreprise", "OKCancel", "Warning")
    if ($rep -ne "OK") { return }
